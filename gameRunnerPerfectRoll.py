...
class GameRunner:
    ...
    def run(self):
        ...
        print("in the first 3 rounds i needed help: ", count_of_help_needed_first_3_games,
              " when I made this many decisions...",
              count_of_decisions_first_3_games, "as percent",
              count_of_help_needed_first_3_games / count_of_decisions_first_3_games * 100)

        print("in the last 3 rounds i needed help: ", count_of_help_needed_last_3_games,
              " when I made this many decisions...",
              count_of_decisions_last_3_games, "or as a percent",
              count_of_help_needed_last_3_games / count_of_decisions_last_3_games * 100)
        print(count_of_times_needing_help, " / ", count_of_total_predictions,
              "times needed help in order to function as a percent, ",
              count_of_times_needing_help / count_of_total_predictions * 100)
        ...
        # plot.xlabel("Turn")
        # plot.show()
        print("Average roll_score per game with NN: ", str(total_score / count_of_total_predictions),
              " the num of games played: ", game_count)
